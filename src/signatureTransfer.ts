...
export abstract class SignatureTransfer {
    ...
    public static hash(permit: PermitTransferFrom | PermitBatchTransferFrom, permit2Address: Address, chainId: number, witness?: Witness): Hex {
        const { domain, types, values, primaryType } = SignatureTransfer.getPermitData(permit, permit2Address, chainId, witness);
